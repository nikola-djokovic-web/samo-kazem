...
import { getPost } from "@/lib/placeholder-data";
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            <div className="lg:col-span-2 space-y-6">
                                <div className="grid gap-3">
                                    ...
                                    <Input id="title" type="text" className="w-full" defaultValue={post.title} />
                                </div>
                                <div className="grid gap-3">
                                ...
                                <div className="grid gap-3">
                                    ...
                                    <Tabs defaultValue="url" className="w-full">
                                        ...
                                        <TabsContent value="url">
                                            <Input id="imageUrl" type="text" defaultValue={post.imageUrl} />
                                        </TabsContent>
